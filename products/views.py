...
from branchoffices.models import CashRegister, Supplier
from cashflow.settings.base import PAGE_TITLE
from products.forms import SupplyForm, SuppliesCategoryForm, CartridgeForm
from products.models import Ticket, TicketDetail, Cartridge, PackageCartridge, Supply, SuppliesCategory
